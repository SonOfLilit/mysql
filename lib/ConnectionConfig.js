var deprecate = require('depd')('mysqljs');
...
function ConnectionConfig(options) {
  ...
  if (options.allowObjectValues !== true && options.allowObjectValues !== false) {
    deprecate('For a better security posture, it is recommended that allowObjectValues is set to false, which will become the default in version 3.0, unless you need it and are aware of the security requirement to typecheck values passed to .query(), .format() and .escape()');
  }
  ...
  this.allowObjectValues  = options.allowObjectValues !== false;
