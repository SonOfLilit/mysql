...
function Connection(options) {
  ...
  this.config = Object.assign({allowObjectValues: true}, options.config);
...
Connection.prototype.format = function(sql, values) {
  if (typeof this.config.queryFormat === 'function') {
    return this.config.queryFormat.call(this, sql, values, this.config.timezone, this.config.allowObjectValues);
  }
  return SqlString.format(sql, values, this.config.stringifyObjects, this.config.timezone, this.config.allowObjectValues);
};
